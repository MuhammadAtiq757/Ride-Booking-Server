// server fileimport { Server } from "http";
...
const startServer = async () => {
  try {
    await mongoose.connect(
      "mongodb+srv://757mohammadatiq:757mohammadatiq@cluster0.iyiex3d.mongodb.net/tour-mangement-backend?retryWrites=true&w=majority&appName=Cluster0"
    );
